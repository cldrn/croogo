...
CREATE TABLE IF NOT EXISTS `blocks` (
  ...
  `visibility_roles` text collate utf8_unicode_ci default NULL,
  `visibility_paths` text collate utf8_unicode_ci default NULL,
  `visibility_php` text collate utf8_unicode_ci default NULL,
